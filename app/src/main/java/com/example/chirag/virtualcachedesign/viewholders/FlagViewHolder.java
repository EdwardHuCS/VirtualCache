...
public class FlagViewHolder extends RecyclerView.ViewHolder {
    ...
    public FlagViewHolder(View itemView, final Context context) {
        super(itemView);
        this.context = context;
    }

    public void setFlag(int flag, final String countryCode) {
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MainActivity) context).changeCountryCode(countryCode);
            }
        });
    }
